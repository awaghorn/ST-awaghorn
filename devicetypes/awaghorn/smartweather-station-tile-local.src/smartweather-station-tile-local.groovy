 ...
 *  Date: 2013-04-30
 *
 *  Modified by Andrew Waghorn to add more frequent poll and remove null in UK display as no state
 */
metadata {
    definition (name: "SmartWeather Station Tile - local", namespace: "awaghorn", author: "Andrew Waghorn") {
...
def poll() {
    ...
    if (obs) {
        ...
        def cityValue = "${loc.city} ${loc.countryCode}"
