...
metadata {
 ...
 //           }
		...
		//AMW edit to fix crash on colour selector
        controlTile ("colorpicker","device.color", "color", height: 4, width: 4, inactiveLabel: false) {
        ...
        controlTile("levelRedSlider", "device.levelRed", "slider", range:"(0..100)", height: 1, width: 1, inactiveLabel: false) {
        ...
        controlTile("levelGreenSlider", "device.levelGreen", "slider", range:"(0..100)", height: 1, width: 1, inactiveLabel: false) {
        ...
        controlTile("levelBlueSlider", "device.levelBlue", "slider", range:"(0..100)", height: 1, width: 1, inactiveLabel: false) {
        ...
        controlTile("levelWhiteSlider", "device.levelWhite", "slider", range:"(0..100)", height: 1, width: 1, inactiveLabel: false) {
        ...
        controlTile("levelCh1Slider", "device.levelCh1", "slider", range:"(0..100)", height: 1, width: 1, inactiveLabel: false) {
        ...
        controlTile("levelCh2Slider", "device.levelCh2", "slider", range:"(0..100)", height: 1, width: 1, inactiveLabel: false) {
        ...
        controlTile("levelCh3Slider", "device.levelCh3", "slider", range:"(0..100)", height: 1, width: 1, inactiveLabel: false) {
        ...
        controlTile("levelCh4Slider", "device.levelCh4", "slider", range:"(0..100)", height: 1, width: 1, inactiveLabel: false) {
